# Poșta Română Tracking API For Java
Poșta Română Tracking API and webhook make it easy to integrate Poșta Română Tracking function into your own project. Support APIs Client Libraries for java

### API key

In order to use this API, you need to generate a Poșta Română Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Poșta Română Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Poșta Română Tracking API](https://www.trackingmore.com/posta-romana-tracking.html)  to:

   *   Get Poșta Română realtime tracking info of muti-carriers in one integration
   *   Provide Poșta Română shipment tracking experience like Amazon
   *   Push Poșta Română notifications of package update with webhook
   *   Verify Poșta Română delivery exception before it is too late
